...
| | Proposal | Effort | Status |
|---|---|---|---|
| 025 | [Publish in Kazakh and Russian without machine translation](025-localisation.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/30) |
| 026 | [Search the index at build time, not the page at request time](026-search.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/31) |
| 027 | [Make the performance budget falsifiable, then print the bytes](027-performance-monitoring.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/32) |
| 028 | [Run accessibility as a standing practice, not a one-off audit](028-accessibility-programme.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/33) |
| 029 | [Find out the form is broken before the applications stop](029-observability.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/34) |
| 030 | [Handle students' personal data properly](030-data-protection.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/35) |

### Growth

| | Proposal | Effort | Status |
|---|---|---|---|
| 031 | [Push the site's facts into the Telegram group the club already lives in](031-telegram-bot.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/36) |
| 033 | [Read a project's health from its repository, not its Markdown](033-github-integration.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/37) |
| 034 | [Record what happens to people after they leave](034-outcomes-and-alumni.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/38) |
| 035 | [Position QairuHub inside the Kazakh AI ecosystem](035-ecosystem-and-partnerships.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/39) |
| 036 | [Hold three Fridays, then ship six things, and defer the rest for a year](036-the-first-hundred-days.md) | — | [in review](https://github.com/tairqaldy/qairuhub-web/pull/40) |
...
35 proposals, 35 still open for review. Generated by `node scripts/index-proposals.mjs` — do not edit by hand.
